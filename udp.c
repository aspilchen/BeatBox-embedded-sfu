...
static int32_t udp_receiveImpl(char* buffer, const int32_t socketDescriptor, const uint32_t maxLen, struct sockaddr_in* sockAddr);
...
int32_t udp_receive(char* buffer, const int32_t socketDescriptor, const uint32_t maxLen, struct sockaddr_in* sockAddr)
{
	return udp_receiveImpl(buffer, socketDescriptor, maxLen, sockAddr);
}
